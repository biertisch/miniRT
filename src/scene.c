...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/27 12:38:37 by bliu              #+#    #+#             */
/*   Updated: 2025/12/27 12:38:38 by bliu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
t_checker_tex *checker_tex = checker_texture_colors(0.99, 
	get_color(0.2, 0.3, 0.1), get_color(0.9, 0.9, 0.9));
t_material material_checker = get_material_texture(LAMBERTIAN, 
	(t_texture *)checker_tex, 0.0);
...
t_quad left = new_quad(new_vec3(555, 0, 0), new_vec3(0, 555, 0), 
	new_vec3(0, 0, 555), green);
t_quad right = new_quad(new_vec3(0, 0, 0), new_vec3(0, 555, 0), 
	new_vec3(0, 0, 555), red);

// t_quad	light_quad = new_quad(new_vec3(343, 554, 332), 
	new_vec3(-230, 0, 0), new_vec3(0, 0, -205), light);
t_quad light_quad = new_quad(new_vec3(213, 554, 227), 
	new_vec3(130, 0, 0), new_vec3(0, 0, 105), light);
// t_quad light_spot = new_quad(new_vec3(213,554,332), 
	new_vec3(130, 0, 0), new_vec3(0, 0, -105), light);
// t_quad	light_quad2 = new_quad(new_vec3(454, 478, 554), 
	new_vec3(-180, 0, 0), new_vec3(0, -180, 0), light);
// add_object_to_world(wld, QUAD, &light_quad2);
t_quad ceiling = new_quad(new_vec3(0, 0, 0), new_vec3(555, 0, 0), 
	new_vec3(0, 0, 555), white);
t_quad floor = new_quad(new_vec3(555, 555, 555), new_vec3(-555, 0, 0), 
	new_vec3(0, 0, -555), white);
t_quad back = new_quad(new_vec3(0, 0, 555), new_vec3(555, 0, 0), 
	new_vec3(0, 555, 0), metal);

// t_material	cyl_material = get_material(LAMBERTIAN, 
	get_color(.0, 1.0, .0), 1.5);
t_cylinder cyl1 = {(t_vec3){443, 100, 432}, (t_vec3){0, 1, 0}, 80, 200, red};
// t_cylinder cyl1 = new_cylinder(new_vec3(443, 100, 432), 
	new_vec3(0, 1, 0), 80, 200, red);
// t_cylinder cyl2 = new_cylinder(new_vec3(143, 200, 232), 
	new_vec3(0, 1, 0), 80, 400, green);
...
wld->camera.forword = vec3_norm(vec3_sub(new_vec3(278, 278, 0), 
	wld->camera.lookfrom));
wld->camera.vup = new_vec3(0, 1, 0);
...
t_cylinder cyl2 = new_cylinder(new_vec3(143, 200, 232), 
	new_vec3(0, 1, 0), 80, 400, green);
t_cylinder cyl3 = new_cylinder(new_vec3(243, 250, 532), 
	new_vec3(0, 1, 0), 80, 150, blue);
add_object_to_world(wld, CYLINDER, &cyl1);
add_object_to_world(wld, CYLINDER, &cyl2);
...
// Ground plane
t_checker_tex *checker_tex = checker_texture_colors(0.011, 
	get_color(0.2, 0.3, 0.1), get_color(0.9, 0.9, 0.9));
t_material material_checker = get_material_texture(LAMBERTIAN, 
	(t_texture *)checker_tex, 0.0);
t_material mat_ground = get_material(LAMBERTIAN, get_color(1, 1, 1), 0.0);
t_plane ground_plane = new_plane(new_vec3(0, -2, 0), 
	new_vec3(0, 1, 0), material_checker);
...
{
// Implement the mandatory base scene setup here
t_material metal = get_material(METAL, 
	get_color(255, 255 * .85, 255 * .31), 0.0);
t_material red = get_material(LAMBERTIAN, 
	get_color(0, 255 * 0.35, 255 * 0.35), 0.0);
...
t_material mat_ground = get_material(LAMBERTIAN, get_color(1, 1, 1), 0.0);
t_plane ground_plane = new_plane(new_vec3(0, 0, 0), 
	new_vec3(0, 1, 0), material_checker);
add_object_to_world(wld, PLANE, &ground_plane);
