NAME = miniRT
SRC = $(addprefix src/, main.c color.c vec3.c ray.c sphere.c hittable_list.c interval.c camera_animation.c \
						camera.c rt_utils.c material.c action.c action_extend.c quad.c plane.c cylinder.c cylinder_utils.c \
